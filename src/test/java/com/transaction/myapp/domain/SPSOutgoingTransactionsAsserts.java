...
public class SPSOutgoingTransactionsAsserts {
     ...
     */
    public static void assertSPSOutgoingTransactionsAllPropertiesEquals(SPSOutgoingTransactions expected, SPSOutgoingTransactions actual) {
        assertSPSOutgoingTransactionsAutoGeneratedPropertiesEquals(expected, actual);
        assertSPSOutgoingTransactionsAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertSPSOutgoingTransactionsAllUpdatablePropertiesEquals(
        SPSOutgoingTransactions expected,
        SPSOutgoingTransactions actual
    ) {
        assertSPSOutgoingTransactionsUpdatableFieldsEquals(expected, actual);
        assertSPSOutgoingTransactionsUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertSPSOutgoingTransactionsAutoGeneratedPropertiesEquals(
        SPSOutgoingTransactions expected,
        SPSOutgoingTransactions actual
    ) {
        assertThat(actual)
            .as("Verify SPSOutgoingTransactions auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertSPSOutgoingTransactionsUpdatableFieldsEquals(
        SPSOutgoingTransactions expected,
        SPSOutgoingTransactions actual
    ) {
        assertThat(actual)
            .as("Verify SPSOutgoingTransactions relevant properties")
            ...
            .satisfies(a -> assertThat(a.getCallbackstatus()).as("check callbackstatus").isEqualTo(expected.getCallbackstatus()))
            .satisfies(a -> assertThat(a.getCallbackstatusdesc()).as("check callbackstatusdesc").isEqualTo(expected.getCallbackstatusdesc())
            );
    }
     ...
     * @param actual the actual entity
     */
    public static void assertSPSOutgoingTransactionsUpdatableRelationshipsEquals(
        SPSOutgoingTransactions expected,
        SPSOutgoingTransactions actual
    ) {
        // empty method
